...
const outputSchema = z.object({
	colorNames: z.array(z.string()).describe("The applicable color names for the product"),
	hexColors: z.array(z.string()).describe("The applicable hex colors for the product"),
	materials: z.array(z.string()).describe("The applicable materials for the product"),
	styles: z.array(z.enum(productStyles)).describe("The applicable styles for the product"),
});
