...
const systemPrompt = `
You are an expert in analyzing product data and main image and returning the applicable style data (color names, hex colors, materials, and styles form the style list).
...
export default async function productStyleGeneratorAi(args: {
  headerLine: string;
